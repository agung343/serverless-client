          ...
          <tbody>
            {products.map((product, i) => (
              <tr key={product.id} className="font-light">
                <td className="p-2 border dark:border-stone-100">{i + 1 + (page - 1) * limit}</td>
                <td className="p-2 border dark:border-stone-100">{product.name}</td>
                <td className="p-2 border dark:border-stone-100">{product.code}</td>
